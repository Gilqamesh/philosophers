...
/*   Updated: 2021/09/26 22:58:17 by edavid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philosopher_info
{
	...
	t_philo_set_of_forks	*reference_to_left_neighbours_set_of_forks;
	t_philo_set_of_forks	*reference_to_right_neighbours_set_of_forks;
	t_philo_fork			*reference_to_left_fork;
	t_philo_fork			*reference_to_right_fork;
